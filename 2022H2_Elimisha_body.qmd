...
\fancypagestyle{myCoverStyle}{
  ...
  \fancyfoot[R]{\thepage}
  \fancyfoot[C]{\em{Cover picture : Niko (sponsorship manager) having a catch-up with a sponsored student at a school in Kibera}}
...
-   Improved performance e.g. *I* and *S*.

-   Good behaviour/Character e.g. *B*

-   The children are more confident when expressing themselves e.g. *B* and *O*.
