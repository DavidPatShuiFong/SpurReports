...
# render
quarto_render( "2023H1_Elimisha_cover.qmd", output_format = "titlepage-pdf")
quarto_render( "2023H1_Elimisha_body.qmd", output_format = "PrettyPDF-pdf")

tmp_pdf_filename <- file_temp(ext = "pdf")

# combine
pdf_combine(
  c("2023H1_Elimisha_cover.pdf", "2023H1_Elimisha_body.pdf"),
