...
# render
quarto_render( "2022H2_Mentorship_cover.qmd", output_format = "titlepage-pdf")
quarto_render( "2022H2_Mentorship_body.qmd", output_format = "PrettyPDF-pdf")

tmp_pdf_filename <- file_temp(ext = "pdf")

# combine
pdf_combine(
  c("2022H2_Mentorship_cover.pdf", "2022H2_Mentorship_body.pdf"),
